    ...
    public static unsafe object?[] ReadParams(FArchive bunch, FRpcParamDef[] paramDefs) {
        ...
        for (var i = 0; i < paramDefs.Length; i++) {
            ...
            values[i] = def.Kind switch {
                ...
                ERpcParamKind.LevelVisibility => FUpdateLevelVisibilityLevelInfo.NetSerializeRead(bunch),
                ERpcParamKind.LevelVisibilityArray => FUpdateLevelVisibilityLevelInfo.NetSerializeReadArray(bunch),
