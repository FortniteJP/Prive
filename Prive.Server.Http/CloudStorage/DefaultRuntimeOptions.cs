    ...
    public override List<IniElementSection> Elements => new() {
        new() {
            ...
            Elements = new() {
				...
				new IniElementKeyValue("bAllowLFG", "true"),
				new IniElementKeyValue("bEnableContextHelpMenu", "true"),
				...
				new IniElementKeyValue("bObscuredPlatformIcons", "false"),
				new IniElementKeyValue("bEnableOfflineFriendsList", "false"),
				new IniElementKeyValue("bEnableRecentPlayerList", "false"),
				new IniElementKeyValue("bEnableSuggestedFriendList", "false"),
				new IniElementKeyValue("bEnableBlockedList", "false"),
				new IniElementKeyValue("bEnableSitoutOption", "false"),
				new IniElementKeyValue("bEnableVoiceSpeakerWidget", "false"),
				new IniElementKeyValue("bEnableMatchmakingRegionSetting", "false"),
				new IniElementKeyValue("bAllowAccessToAllEmotesForTesting", "true"),
				new IniElementKeyValue("bRequireEmoteOwnershipInPIE", "false"),
				new IniElementKeyValue("bSkipTrailerMovie", "true"),
				new IniElementKeyValue("bAlwaysPlayTrailerMovie", "false"),
				new IniElementKeyValue("bEnableNewSettingsScreen", "true"),
				new IniElementKeyValue("bEnableNewFireModeSelection", "true"),
				...
				new IniElementKeyValue("bActiveDisplayDeviceTemperature", "true"),
