...
public class ModifiedDefaultGame : CloudStorageFile {
    ...
    public static string[] AthenaResourceRates { get; } = new[] {
        "ResourceLow",
        "ResourceSmall",
        "ResourceMedium",
        "ResourceHigh",
        ...
        "ResourceMetalMedium",
        "ResourceMetalHigh",
        "ResourceMetalVeryHigh",
        "ResourceStoneLow",
        "ResourceStoneMedium",
        "ResourceStoneHigh",
        "ResourceStoneVeryHigh",
        "ResourceWoodLow",
        "ResourceWoodMedium",
        "ResourceWoodHigh",
        "ResourceWoodVeryHigh",
        "LDBuildingNormal",
        "LDBuildingThick",
        "PropWoodLow",
        "PropWoodMedium",
    ...
    public override List<IniElementSection> Elements { get {
        var result = new List<IniElementSection>() {
            new() {
            ...
            new() {
                ...
                Elements = new() {
                    ...
                    new IniFrontEndPlaylistData() {
                        ...
                        PlaylistAccess = new() { bDisplayAsNew = true }
                        }
                    }
                }
            },
        ...
        var assetHotfix = new IniElementSection() {
            Section = "AssetHotfix",
            Elements = new() {
                ...
                new IniElementKeyValue("DataTable", "/Game/Athena/Items/Weapons/AthenaMeleeWeapons;RowUpdate;Harvest_Pickaxe_Athena_C_T01;EquipAnimRate;1.95") { Option = IniElementOption.AddIfMissing },
                ...
                new IniElementKeyValue("DataTable", "/Game/Athena/Items/Weapons/AthenaMeleeWeapons;RowUpdate;Harvest_Pickaxe_Athena_C_T01;EnvDmgPB;100.0") { Option = IniElementOption.AddIfMissing },
                new IniElementKeyValue("DataTable", "/Game/Athena/Items/Weapons/AthenaMeleeWeapons;RowUpdate;Harvest_Pickaxe_Athena_C_T01;EnvDmgMid;100.0") { Option = IniElementOption.AddIfMissing },
                new IniElementKeyValue("DataTable", "/Game/Athena/Items/Weapons/AthenaMeleeWeapons;RowUpdate;Harvest_Pickaxe_Athena_C_T01;EnvDmgLong;100.0") { Option = IniElementOption.AddIfMissing },
                new IniElementKeyValue("DataTable", "/Game/Athena/Items/Weapons/AthenaMeleeWeapons;RowUpdate;Harvest_Pickaxe_Athena_C_T01;EnvDmgMaxRange;100.0") { Option = IniElementOption.AddIfMissing },
            }
        };
        foreach (var name in AthenaResourceRates) {
            assetHotfix.Elements.Add(new IniElementKeyValue("CurveTable", $"/Game/Athena/Balance/DataTables/AthenaResourceRates;RowUpdate;{name};0;100.0") { Option = IniElementOption.AddIfMissing });
            assetHotfix.Elements.Add(new IniElementKeyValue("CurveTable", $"/Game/Athena/Balance/DataTables/AthenaResourceRates;RowUpdate;{name};1;100.0") { Option = IniElementOption.AddIfMissing });
        }
        result.Add(assetHotfix);
        return result;
    } }
}