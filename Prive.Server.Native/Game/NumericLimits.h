...
template <typename NumericType>
struct TNumericLimits<const NumericType> : TNumericLimits<NumericType> {};

template <typename NumericType>
struct TNumericLimits<volatile NumericType> : TNumericLimits<NumericType> {};

template <typename NumericType>
struct TNumericLimits<const volatile NumericType> : TNumericLimits<NumericType> {};
